...
/**
 * Shortcode to Display Portfolios
 */
function mohi_portfolio_shortcode( $atts ) {
                        ...
                        <div class="card h-100 border-0 shadow-sm custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted small mb-2">
                                    <a class="text-decoration-none text-dark"
                                       ...
                                       title="<?php echo esc_attr( get_the_author() ); ?>">
                                        <i class="bi bi-person me-2"></i><?php the_author(); ?>
                                    </a>
                                    &nbsp;|&nbsp;
                                ...
                                <a href="<?php the_permalink(); ?>" target="_black" class="btn btn-outline-dark btn-sm text-decoration-none">
                                    <?php esc_html_e( 'View Project', 'mohi-cpt' ); ?>
                                </a>
    ...
    <?php else : ?>
        <div class="col-12 text-center">
            <p><?php esc_html_e( 'No portfolios found.', 'mohi-cpt' ); ?></p>
        </div>
    <?php endif;
...
add_shortcode( 'mohicpt_portfolio', 'mohi_portfolio_shortcode' );